...
In this blog post, I will cover my [own implementation in github](https://github.com/jayeshmahapatra/llama2.npy) porting llama2.c to do inference using only python and Numpy. I will go through the basics of the Llama2 architecture and the main modules of the inference pipeline like the tokenizer, attention, embeddings and the text generator.
