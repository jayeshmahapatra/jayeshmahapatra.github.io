...
3. **Calculate Scores and apply causal mask**: We can get a score matrix containing scores for each token with respect to other tokens by using the equation: <br> <p align="center"> $$ S = Q \times K^T $$ </p> <br>
