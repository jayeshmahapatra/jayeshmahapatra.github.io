...
and hence we can go through the attention process multiple times to generate multiple encodings $ Z_{i} $ where i goes from $ 0 $ to $ n - 1 $, $ n $ being the number of heads.
