...
3. **Transformer Blocks**: Then the embeddings are fed into layers of Transformer Blocks which consist of RMS Norms,Attention, Rotary Positional Embeddings and Feed Forwards Networks.
