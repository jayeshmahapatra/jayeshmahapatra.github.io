...
<p align="center">
   <figure>
   <img src="/media/embedding_example.png" width="700" height="490"/>
...
As we can see that the arcface loss results in embedding clusters that are more cleanly separated as well as are more compact.
